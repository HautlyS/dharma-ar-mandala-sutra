...
const CharacterDisplay = () => {
  return <Card className="h-full bg-black/30 border-white/10 backdrop-blur-md relative overflow-hidden">
      {/* Main Character Image */}
      <div className="absolute inset-0">
        <img src="/lovable-uploads/c219c420-66d4-4e18-8ba6-e6667fac8aba.png" alt="Buddhist deity" className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-black/20 absolute "></div>
      </div>
      ...
      <div className="absolute inset-0 pointer-events-none z-10">
        {[...Array(8)].map((_, i) => <div key={i} className="absolute w-1 h-1 bg-gold/40 rounded-full animate-float" style={{
